...
문단 본문은 일반적으로 텍스트로 구성되나, 경우에 따라 이미지, 수식기호등이 포함될 수 있습니다. 따라서 문단내 행간은 가변적으로 조정이 될 수 있습니다. 이렇게 ![](.gitbook/assets/readme-01.png) 나 $$f(x) = x * e^{2 pi i \xi x}$$ 과 같은 수식기호를 넣을 수 있습니다. 또한 문단간의 간격은 문단내 행간과는 다르게 구성됩니다.

이건 위 문단과 다른 문단입니다. 이렇게 문단내 행간과 명확히 구분이 됩니다.

디자인적으로 중요하지는 않을 것 같긴 하지만 _이텔릭체_, **볼드**, ~~취소~~, <mark style="color:purple;">언더스코어</mark>, `강조` 를 사용할 수 있습니다.
